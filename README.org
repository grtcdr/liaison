...
For a minimal working example, check out [[https://github.com/grtcdr/forgecast/tree/example][the example branch]] in addition to [[https://grtcdr.tn/forgecast][the live website]].
